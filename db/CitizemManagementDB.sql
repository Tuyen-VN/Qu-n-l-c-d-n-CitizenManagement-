...
-- BẢNG 5: Users
-- citizen_id: liên kết tài khoản → hồ sơ công dân (NULL = tài khoản nội bộ)
CREATE TABLE Users (
...
-- BẢNG 6: Citizens
-- gender đồng nhất tiếng Anh để khớp với toàn bộ backend
CREATE TABLE Citizens (
    citizen_id        INT PRIMARY KEY IDENTITY(1,1),
    citizen_code      NVARCHAR(20) NOT NULL UNIQUE,
    full_name         NVARCHAR(100) NOT NULL,
...
CREATE TABLE Households (
    ...
    head_of_household_id INT NOT NULL,
    address             NVARCHAR(255) NOT NULL,
    ward_id             INT NOT NULL,
    household_type      NVARCHAR(50) DEFAULT N'Thường trú'
                        CHECK (household_type IN (N'Thường trú', N'Tạm trú')),
...
-- Mật khẩu gốc: Admin@123 / Staff@123 / Viewer@123
-- citizen_id = NULL lúc này vì Citizens chưa có dữ liệu
-- Sẽ được gán trong Data.sql sau khi insert công dân
-- ============================================================================
...
-- Viewer (role_id=3) - citizen_id sẽ được gán trong Data.sql
...
PRINT N'Schema và tài khoản hệ thống đã được khởi tạo thành công.';
PRINT N'Chạy tiếp Data.sql để nạp dữ liệu công dân mẫu.';
GO